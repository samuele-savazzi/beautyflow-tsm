  ...
  Future<void> _export(String dataset) async {
    ...
    if (path == null) {
      ApiErrorHandler.showErrorMessage(
        context,
        provider.error ?? 'Export non riuscito',
      );
      return;
    }
              ...
              children: [
                ...
                PopupMenuButton<String>(
                  ...
                  itemBuilder: (_) => const [
                    PopupMenuItem(
                      value: 'invoices',
                      child: Text('Fatture emesse (CSV)'),
                    ),
                    PopupMenuItem(
                      value: 'expenses',
                      child: Text('Costi (CSV)'),
                    ),
                    PopupMenuItem(
                      value: 'movements',
                      child: Text('Movimenti cassa (CSV)'),
                    ),
                  ],
                ),
