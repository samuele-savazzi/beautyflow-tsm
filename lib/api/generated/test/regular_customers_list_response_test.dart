...
// tests for RegularCustomersListResponse
void main() {
  final instance = RegularCustomersListResponseBuilder();
  // TODO add properties to the builder and call build()

  group(RegularCustomersListResponse, () {
    // bool success
    ...
    // BuiltList<RegularCustomerItem> results
