...
// tests for ServiceHistoryListResponse
void main() {
  final instance = ServiceHistoryListResponseBuilder();
  // TODO add properties to the builder and call build()

  group(ServiceHistoryListResponse, () {
    // bool success
    ...
    // BuiltList<ServiceHistoryListItem> results
