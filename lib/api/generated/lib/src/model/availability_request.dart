...
@BuiltValue()
abstract class AvailabilityRequest implements Built<AvailabilityRequest, AvailabilityRequestBuilder> {
  ...
  factory AvailabilityRequest([void updates(AvailabilityRequestBuilder b)]) = _$AvailabilityRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AvailabilityRequestBuilder b) => b
      ..searchOnlyMorning = false
      ..searchOnlyAfternoon = false;

  @BuiltValueSerializer(custom: true)
  static Serializer<AvailabilityRequest> get serializer => _$AvailabilityRequestSerializer();
}

class _$AvailabilityRequestSerializer implements PrimitiveSerializer<AvailabilityRequest> {
  @override
  final Iterable<Type> types = const [AvailabilityRequest, _$AvailabilityRequest];

  @override
  final String wireName = r'AvailabilityRequest';
  ...
  void _deserializeProperties(
    ...
    required AvailabilityRequestBuilder result,
  ...
  @override
  AvailabilityRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AvailabilityRequestBuilder();
