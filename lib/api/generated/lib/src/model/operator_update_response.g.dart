...
part of 'operator_update_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$OperatorUpdateResponse extends OperatorUpdateResponse {
  @override
  final int id;
  @override
  ...
  factory _$OperatorUpdateResponse(
          [void Function(OperatorUpdateResponseBuilder)? updates]) =>
      (OperatorUpdateResponseBuilder()..update(updates))._build();

  _$OperatorUpdateResponse._(
      {required this.id,
      ...
      : super._();
  @override
  OperatorUpdateResponse rebuild(
          void Function(OperatorUpdateResponseBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  OperatorUpdateResponseBuilder toBuilder() =>
      OperatorUpdateResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is OperatorUpdateResponse &&
        id == other.id &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'OperatorUpdateResponse')
          ..add('id', id)
...
class OperatorUpdateResponseBuilder
    implements Builder<OperatorUpdateResponse, OperatorUpdateResponseBuilder> {
  _$OperatorUpdateResponse? _$v;
  ...
  OperatorUpdateResponseBuilder() {
    OperatorUpdateResponse._defaults(this);
  }

  OperatorUpdateResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
  ...
  @override
  void replace(OperatorUpdateResponse other) {
    _$v = other as _$OperatorUpdateResponse;
  }

  @override
  void update(void Function(OperatorUpdateResponseBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  OperatorUpdateResponse build() => _build();

  _$OperatorUpdateResponse _build() {
    _$OperatorUpdateResponse _$result;
    try {
      _$result = _$v ??
          _$OperatorUpdateResponse._(
            id: BuiltValueNullFieldError.checkNotNull(
                id, r'OperatorUpdateResponse', 'id'),
            firstName: BuiltValueNullFieldError.checkNotNull(
                firstName, r'OperatorUpdateResponse', 'firstName'),
            lastName: BuiltValueNullFieldError.checkNotNull(
                lastName, r'OperatorUpdateResponse', 'lastName'),
            role: BuiltValueNullFieldError.checkNotNull(
                role, r'OperatorUpdateResponse', 'role'),
            recoveryEmail: BuiltValueNullFieldError.checkNotNull(
                recoveryEmail, r'OperatorUpdateResponse', 'recoveryEmail'),
            birthDate: BuiltValueNullFieldError.checkNotNull(
                birthDate, r'OperatorUpdateResponse', 'birthDate'),
            isActive: BuiltValueNullFieldError.checkNotNull(
                isActive, r'OperatorUpdateResponse', 'isActive'),
            isDisabled: BuiltValueNullFieldError.checkNotNull(
                isDisabled, r'OperatorUpdateResponse', 'isDisabled'),
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'OperatorUpdateResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
