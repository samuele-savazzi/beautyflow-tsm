...
part 'discount_type_create_response.g.dart';

/// DiscountTypeCreateResponse
///
/// Properties:
/// * [id] 
/// * [name] 
...
/// * [createdAt] 
@BuiltValue()
abstract class DiscountTypeCreateResponse implements Built<DiscountTypeCreateResponse, DiscountTypeCreateResponseBuilder> {
  ...
  DiscountTypeCreateResponse._();

  factory DiscountTypeCreateResponse([void updates(DiscountTypeCreateResponseBuilder b)]) = _$DiscountTypeCreateResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DiscountTypeCreateResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<DiscountTypeCreateResponse> get serializer => _$DiscountTypeCreateResponseSerializer();
}

class _$DiscountTypeCreateResponseSerializer implements PrimitiveSerializer<DiscountTypeCreateResponse> {
  @override
  final Iterable<Type> types = const [DiscountTypeCreateResponse, _$DiscountTypeCreateResponse];

  @override
  final String wireName = r'DiscountTypeCreateResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    DiscountTypeCreateResponse object, {
  ...
  void _deserializeProperties(
    ...
    required DiscountTypeCreateResponseBuilder result,
  ...
  @override
  DiscountTypeCreateResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = DiscountTypeCreateResponseBuilder();
