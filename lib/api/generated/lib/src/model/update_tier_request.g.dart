...
part of 'update_tier_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$UpdateTierRequest extends UpdateTierRequest {
  @override
  final String? name;
  @override
  ...
  factory _$UpdateTierRequest(
          [void Function(UpdateTierRequestBuilder)? updates]) =>
      (UpdateTierRequestBuilder()..update(updates))._build();

  _$UpdateTierRequest._(
      {this.name,
      this.description,
      this.icon,
      this.category,
      ...
      : super._();
  @override
  UpdateTierRequest rebuild(void Function(UpdateTierRequestBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  UpdateTierRequestBuilder toBuilder() =>
      UpdateTierRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is UpdateTierRequest &&
        name == other.name &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'UpdateTierRequest')
          ..add('name', name)
...
class UpdateTierRequestBuilder
    implements Builder<UpdateTierRequest, UpdateTierRequestBuilder> {
  _$UpdateTierRequest? _$v;
  ...
  UpdateTierRequestBuilder() {
    UpdateTierRequest._defaults(this);
  }

  UpdateTierRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _name = $v.name;
  ...
  @override
  void replace(UpdateTierRequest other) {
    _$v = other as _$UpdateTierRequest;
  }

  @override
  void update(void Function(UpdateTierRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  UpdateTierRequest build() => _build();

  _$UpdateTierRequest _build() {
    _$UpdateTierRequest _$result;
    try {
      _$result = _$v ??
          _$UpdateTierRequest._(
            name: name,
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'UpdateTierRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
