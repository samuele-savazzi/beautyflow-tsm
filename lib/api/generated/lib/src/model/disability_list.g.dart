...
part of 'disability_list.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$DisabilityList extends DisabilityList {
  @override
  final int id;
  @override
  ...
  factory _$DisabilityList([void Function(DisabilityListBuilder)? updates]) =>
      (DisabilityListBuilder()..update(updates))._build();
  ...
  _$DisabilityList._(
      ...
      : super._();
  @override
  DisabilityList rebuild(void Function(DisabilityListBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  DisabilityListBuilder toBuilder() => DisabilityListBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is DisabilityList &&
        id == other.id &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'DisabilityList')
          ..add('id', id)
...
class DisabilityListBuilder
    implements Builder<DisabilityList, DisabilityListBuilder> {
  _$DisabilityList? _$v;
  ...
  DisabilityListBuilder() {
    DisabilityList._defaults(this);
  }

  DisabilityListBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
  ...
  @override
  void replace(DisabilityList other) {
    _$v = other as _$DisabilityList;
  }

  @override
  void update(void Function(DisabilityListBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  DisabilityList build() => _build();

  _$DisabilityList _build() {
    _$DisabilityList _$result;
    try {
      _$result = _$v ??
          _$DisabilityList._(
            id: BuiltValueNullFieldError.checkNotNull(
                id, r'DisabilityList', 'id'),
            workstation: workstation.build(),
            reason: BuiltValueNullFieldError.checkNotNull(
                reason, r'DisabilityList', 'reason'),
            startDate: BuiltValueNullFieldError.checkNotNull(
                startDate, r'DisabilityList', 'startDate'),
            endDate: endDate,
            timeSlots: timeSlots.build(),
            createdAt: BuiltValueNullFieldError.checkNotNull(
                createdAt, r'DisabilityList', 'createdAt'),
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'DisabilityList', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
