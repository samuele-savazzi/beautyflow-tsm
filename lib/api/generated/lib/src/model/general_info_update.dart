...
part 'general_info_update.g.dart';
...
/// * [macroArea] 
@BuiltValue()
abstract class GeneralInfoUpdate implements Built<GeneralInfoUpdate, GeneralInfoUpdateBuilder> {
  ...
  factory GeneralInfoUpdate([void updates(GeneralInfoUpdateBuilder b)]) = _$GeneralInfoUpdate;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(GeneralInfoUpdateBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<GeneralInfoUpdate> get serializer => _$GeneralInfoUpdateSerializer();
}

class _$GeneralInfoUpdateSerializer implements PrimitiveSerializer<GeneralInfoUpdate> {
  @override
  final Iterable<Type> types = const [GeneralInfoUpdate, _$GeneralInfoUpdate];

  @override
  final String wireName = r'GeneralInfoUpdate';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    GeneralInfoUpdate object, {
  ...
  void _deserializeProperties(
    ...
    required GeneralInfoUpdateBuilder result,
  ...
  @override
  GeneralInfoUpdate deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = GeneralInfoUpdateBuilder();
