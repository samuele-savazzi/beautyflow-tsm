...
part of 'discount_type_update.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$DiscountTypeUpdate extends DiscountTypeUpdate {
  @override
  final String? name;
  @override
  ...
  factory _$DiscountTypeUpdate(
          [void Function(DiscountTypeUpdateBuilder)? updates]) =>
      (DiscountTypeUpdateBuilder()..update(updates))._build();

  _$DiscountTypeUpdate._(
      {this.name,
      this.valueType,
      this.discountType,
      ...
      : super._();
  @override
  DiscountTypeUpdate rebuild(
          void Function(DiscountTypeUpdateBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  DiscountTypeUpdateBuilder toBuilder() =>
      DiscountTypeUpdateBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is DiscountTypeUpdate &&
        name == other.name &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'DiscountTypeUpdate')
          ..add('name', name)
...
class DiscountTypeUpdateBuilder
    implements Builder<DiscountTypeUpdate, DiscountTypeUpdateBuilder> {
  _$DiscountTypeUpdate? _$v;
  ...
  DiscountTypeUpdateBuilder() {
    DiscountTypeUpdate._defaults(this);
  }

  DiscountTypeUpdateBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _name = $v.name;
  ...
  @override
  void replace(DiscountTypeUpdate other) {
    _$v = other as _$DiscountTypeUpdate;
  }

  @override
  void update(void Function(DiscountTypeUpdateBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  DiscountTypeUpdate build() => _build();

  _$DiscountTypeUpdate _build() {
    final _$result = _$v ??
        _$DiscountTypeUpdate._(
          name: name,
          valueType: valueType,
