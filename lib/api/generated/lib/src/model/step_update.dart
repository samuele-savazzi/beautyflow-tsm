...
import 'package:beautyflow_api/src/model/category_group_update.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'step_update.g.dart';
...
/// * [dragId] 
@BuiltValue()
abstract class StepUpdate implements Built<StepUpdate, StepUpdateBuilder> {
  ...
  CategoryGroupUpdate get categoryGroup;
  ...
  factory StepUpdate([void updates(StepUpdateBuilder b)]) = _$StepUpdate;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(StepUpdateBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<StepUpdate> get serializer => _$StepUpdateSerializer();
}

class _$StepUpdateSerializer implements PrimitiveSerializer<StepUpdate> {
  @override
  final Iterable<Type> types = const [StepUpdate, _$StepUpdate];

  @override
  final String wireName = r'StepUpdate';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      ...
      specifiedType: const FullType(CategoryGroupUpdate),
    );
    yield r'icon';
    yield serializers.serialize(
      object.icon,
  ...
  void _deserializeProperties(
    ...
    required StepUpdateBuilder result,
  ...
  @override
  StepUpdate deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = StepUpdateBuilder();
