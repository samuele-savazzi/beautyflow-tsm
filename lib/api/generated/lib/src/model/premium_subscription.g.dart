...
part of 'premium_subscription.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$PremiumSubscription extends PremiumSubscription {
  @override
  final int id;
  @override
  ...
  factory _$PremiumSubscription(
          [void Function(PremiumSubscriptionBuilder)? updates]) =>
      (PremiumSubscriptionBuilder()..update(updates))._build();

  _$PremiumSubscription._(
      {required this.id,
      ...
      : super._();
  @override
  PremiumSubscription rebuild(
          void Function(PremiumSubscriptionBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  PremiumSubscriptionBuilder toBuilder() =>
      PremiumSubscriptionBuilder()..replace(this);
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PremiumSubscription')
          ..add('id', id)
...
class PremiumSubscriptionBuilder
    implements Builder<PremiumSubscription, PremiumSubscriptionBuilder> {
  _$PremiumSubscription? _$v;
  ...
  PremiumSubscriptionBuilder() {
    PremiumSubscription._defaults(this);
  }

  PremiumSubscriptionBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
  ...
  @override
  void replace(PremiumSubscription other) {
    _$v = other as _$PremiumSubscription;
  }

  @override
  void update(void Function(PremiumSubscriptionBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  PremiumSubscription build() => _build();

  _$PremiumSubscription _build() {
    _$PremiumSubscription _$result;
    try {
      _$result = _$v ??
          _$PremiumSubscription._(
            id: BuiltValueNullFieldError.checkNotNull(
                id, r'PremiumSubscription', 'id'),
            customer: customer.build(),
            customerId: BuiltValueNullFieldError.checkNotNull(
                customerId, r'PremiumSubscription', 'customerId'),
            premiumType: premiumType.build(),
            premiumTypeId: BuiltValueNullFieldError.checkNotNull(
                premiumTypeId, r'PremiumSubscription', 'premiumTypeId'),
            startDate: BuiltValueNullFieldError.checkNotNull(
                startDate, r'PremiumSubscription', 'startDate'),
            endDate: BuiltValueNullFieldError.checkNotNull(
                endDate, r'PremiumSubscription', 'endDate'),
            paidPrice: BuiltValueNullFieldError.checkNotNull(
                paidPrice, r'PremiumSubscription', 'paidPrice'),
            active: active,
            daysRemaining: BuiltValueNullFieldError.checkNotNull(
                daysRemaining, r'PremiumSubscription', 'daysRemaining'),
            createdAt: BuiltValueNullFieldError.checkNotNull(
                createdAt, r'PremiumSubscription', 'createdAt'),
            notes: notes,
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'PremiumSubscription', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
