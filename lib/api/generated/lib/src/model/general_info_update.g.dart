...
part of 'general_info_update.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$GeneralInfoUpdate extends GeneralInfoUpdate {
  @override
  final String name;
  @override
  ...
  factory _$GeneralInfoUpdate(
          [void Function(GeneralInfoUpdateBuilder)? updates]) =>
      (GeneralInfoUpdateBuilder()..update(updates))._build();

  _$GeneralInfoUpdate._(
      {required this.name,
      ...
      : super._();
  @override
  GeneralInfoUpdate rebuild(void Function(GeneralInfoUpdateBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  GeneralInfoUpdateBuilder toBuilder() =>
      GeneralInfoUpdateBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is GeneralInfoUpdate &&
        name == other.name &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GeneralInfoUpdate')
          ..add('name', name)
...
class GeneralInfoUpdateBuilder
    implements Builder<GeneralInfoUpdate, GeneralInfoUpdateBuilder> {
  _$GeneralInfoUpdate? _$v;
  ...
  GeneralInfoUpdateBuilder() {
    GeneralInfoUpdate._defaults(this);
  }

  GeneralInfoUpdateBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _name = $v.name;
  ...
  @override
  void replace(GeneralInfoUpdate other) {
    _$v = other as _$GeneralInfoUpdate;
  }

  @override
  void update(void Function(GeneralInfoUpdateBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GeneralInfoUpdate build() => _build();

  _$GeneralInfoUpdate _build() {
    final _$result = _$v ??
        _$GeneralInfoUpdate._(
          name: BuiltValueNullFieldError.checkNotNull(
              name, r'GeneralInfoUpdate', 'name'),
          description: BuiltValueNullFieldError.checkNotNull(
              description, r'GeneralInfoUpdate', 'description'),
          minPrice: BuiltValueNullFieldError.checkNotNull(
              minPrice, r'GeneralInfoUpdate', 'minPrice'),
          isChemical: BuiltValueNullFieldError.checkNotNull(
              isChemical, r'GeneralInfoUpdate', 'isChemical'),
