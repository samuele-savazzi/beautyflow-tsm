...
/// * [createdAt] 
@BuiltValue()
abstract class DisabilityList implements Built<DisabilityList, DisabilityListBuilder> {
  ...
  factory DisabilityList([void updates(DisabilityListBuilder b)]) = _$DisabilityList;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DisabilityListBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<DisabilityList> get serializer => _$DisabilityListSerializer();
}

class _$DisabilityListSerializer implements PrimitiveSerializer<DisabilityList> {
  @override
  final Iterable<Type> types = const [DisabilityList, _$DisabilityList];

  @override
  final String wireName = r'DisabilityList';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    DisabilityList object, {
  ...
  void _deserializeProperties(
    ...
    required DisabilityListBuilder result,
  ...
  @override
  DisabilityList deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = DisabilityListBuilder();
