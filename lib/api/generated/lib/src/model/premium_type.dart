...
/// * [updatedAt] 
@BuiltValue()
abstract class PremiumType implements Built<PremiumType, PremiumTypeBuilder> {
  ...
  factory PremiumType([void updates(PremiumTypeBuilder b)]) = _$PremiumType;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PremiumTypeBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PremiumType> get serializer => _$PremiumTypeSerializer();
}

class _$PremiumTypeSerializer implements PrimitiveSerializer<PremiumType> {
  @override
  final Iterable<Type> types = const [PremiumType, _$PremiumType];

  @override
  final String wireName = r'PremiumType';
  ...
  void _deserializeProperties(
    ...
    required PremiumTypeBuilder result,
  ...
  @override
  PremiumType deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PremiumTypeBuilder();
