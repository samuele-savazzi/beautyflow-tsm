...
part of 'consultation_detail_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$ConsultationDetailResponse extends ConsultationDetailResponse {
  @override
  final int id;
  @override
  final int areaId;
  ...
  factory _$ConsultationDetailResponse(
          [void Function(ConsultationDetailResponseBuilder)? updates]) =>
      (ConsultationDetailResponseBuilder()..update(updates))._build();

  _$ConsultationDetailResponse._(
      {required this.id,
      ...
      : super._();
  @override
  ConsultationDetailResponse rebuild(
          void Function(ConsultationDetailResponseBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ConsultationDetailResponseBuilder toBuilder() =>
      ConsultationDetailResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ConsultationDetailResponse &&
        id == other.id &&
        areaId == other.areaId &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ConsultationDetailResponse')
          ..add('id', id)
          ..add('areaId', areaId)
...
class ConsultationDetailResponseBuilder
    implements
        Builder<ConsultationDetailResponse, ConsultationDetailResponseBuilder> {
  _$ConsultationDetailResponse? _$v;
  ...
  ConsultationDetailResponseBuilder() {
    ConsultationDetailResponse._defaults(this);
  }

  ConsultationDetailResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
      _areaId = $v.areaId;
  ...
  @override
  void replace(ConsultationDetailResponse other) {
    _$v = other as _$ConsultationDetailResponse;
  }

  @override
  void update(void Function(ConsultationDetailResponseBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  ConsultationDetailResponse build() => _build();

  _$ConsultationDetailResponse _build() {
    final _$result = _$v ??
        _$ConsultationDetailResponse._(
          id: BuiltValueNullFieldError.checkNotNull(
              id, r'ConsultationDetailResponse', 'id'),
          areaId: BuiltValueNullFieldError.checkNotNull(
              areaId, r'ConsultationDetailResponse', 'areaId'),
          areaName: BuiltValueNullFieldError.checkNotNull(
              areaName, r'ConsultationDetailResponse', 'areaName'),
          operatorId: BuiltValueNullFieldError.checkNotNull(
              operatorId, r'ConsultationDetailResponse', 'operatorId'),
          operatorName: BuiltValueNullFieldError.checkNotNull(
              operatorName, r'ConsultationDetailResponse', 'operatorName'),
          customerId: BuiltValueNullFieldError.checkNotNull(
              customerId, r'ConsultationDetailResponse', 'customerId'),
          customerName: BuiltValueNullFieldError.checkNotNull(
              customerName, r'ConsultationDetailResponse', 'customerName'),
          customerEmail: BuiltValueNullFieldError.checkNotNull(
              customerEmail, r'ConsultationDetailResponse', 'customerEmail'),
          customerPhone: BuiltValueNullFieldError.checkNotNull(
              customerPhone, r'ConsultationDetailResponse', 'customerPhone'),
          serviceId: BuiltValueNullFieldError.checkNotNull(
              serviceId, r'ConsultationDetailResponse', 'serviceId'),
          serviceName: BuiltValueNullFieldError.checkNotNull(
              serviceName, r'ConsultationDetailResponse', 'serviceName'),
          serviceStepsSnapshot: serviceStepsSnapshot,
          serviceDescription: BuiltValueNullFieldError.checkNotNull(
              serviceDescription,
              r'ConsultationDetailResponse',
              'serviceDescription'),
          ...
          status: BuiltValueNullFieldError.checkNotNull(
              status, r'ConsultationDetailResponse', 'status'),
          statusDisplay: BuiltValueNullFieldError.checkNotNull(
              statusDisplay, r'ConsultationDetailResponse', 'statusDisplay'),
          notes: BuiltValueNullFieldError.checkNotNull(
              notes, r'ConsultationDetailResponse', 'notes'),
          createdAt: BuiltValueNullFieldError.checkNotNull(
              createdAt, r'ConsultationDetailResponse', 'createdAt'),
          updatedAt: BuiltValueNullFieldError.checkNotNull(
              updatedAt, r'ConsultationDetailResponse', 'updatedAt'),
          completedAt: completedAt,
          canBeConverted: BuiltValueNullFieldError.checkNotNull(
              canBeConverted, r'ConsultationDetailResponse', 'canBeConverted'),
          canBeCancelled: BuiltValueNullFieldError.checkNotNull(
              canBeCancelled, r'ConsultationDetailResponse', 'canBeCancelled'),
        );
    replace(_$result);
    return _$result;
  }
