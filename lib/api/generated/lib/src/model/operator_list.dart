...
/// * [workingAreas] 
@BuiltValue()
abstract class OperatorList implements Built<OperatorList, OperatorListBuilder> {
  ...
  factory OperatorList([void updates(OperatorListBuilder b)]) = _$OperatorList;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(OperatorListBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<OperatorList> get serializer => _$OperatorListSerializer();
}

class _$OperatorListSerializer implements PrimitiveSerializer<OperatorList> {
  @override
  final Iterable<Type> types = const [OperatorList, _$OperatorList];

  @override
  final String wireName = r'OperatorList';
  ...
  void _deserializeProperties(
    ...
    required OperatorListBuilder result,
  ...
  @override
  OperatorList deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = OperatorListBuilder();
