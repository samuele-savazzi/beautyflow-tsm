...
part 'special_closing_list.g.dart';
...
/// * [afternoonToTime] 
@BuiltValue()
abstract class SpecialClosingList implements Built<SpecialClosingList, SpecialClosingListBuilder> {
  ...
  SpecialClosingList._();

  factory SpecialClosingList([void updates(SpecialClosingListBuilder b)]) = _$SpecialClosingList;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SpecialClosingListBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SpecialClosingList> get serializer => _$SpecialClosingListSerializer();
}

class _$SpecialClosingListSerializer implements PrimitiveSerializer<SpecialClosingList> {
  @override
  final Iterable<Type> types = const [SpecialClosingList, _$SpecialClosingList];

  @override
  final String wireName = r'SpecialClosingList';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    SpecialClosingList object, {
  ...
  void _deserializeProperties(
    ...
    required SpecialClosingListBuilder result,
  ...
  @override
  SpecialClosingList deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SpecialClosingListBuilder();
