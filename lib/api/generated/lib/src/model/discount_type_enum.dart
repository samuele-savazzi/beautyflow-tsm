...
class DiscountTypeEnum extends EnumClass {
  ...
  /// * `registration` - Registration * `friend` - Friend * `normal` - Normal
  @BuiltValueEnumConst(wireName: r'registration')
  static const DiscountTypeEnum registration = _$registration;
  /// * `registration` - Registration * `friend` - Friend * `normal` - Normal
  @BuiltValueEnumConst(wireName: r'friend')
  static const DiscountTypeEnum friend = _$friend;
  /// * `registration` - Registration * `friend` - Friend * `normal` - Normal
  @BuiltValueEnumConst(wireName: r'normal')
  static const DiscountTypeEnum normal = _$normal;
