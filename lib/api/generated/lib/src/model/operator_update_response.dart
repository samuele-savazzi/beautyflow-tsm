...
part 'operator_update_response.g.dart';
...
/// * [workingAreas] 
@BuiltValue()
abstract class OperatorUpdateResponse implements Built<OperatorUpdateResponse, OperatorUpdateResponseBuilder> {
  ...
  OperatorUpdateResponse._();

  factory OperatorUpdateResponse([void updates(OperatorUpdateResponseBuilder b)]) = _$OperatorUpdateResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(OperatorUpdateResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<OperatorUpdateResponse> get serializer => _$OperatorUpdateResponseSerializer();
}

class _$OperatorUpdateResponseSerializer implements PrimitiveSerializer<OperatorUpdateResponse> {
  @override
  final Iterable<Type> types = const [OperatorUpdateResponse, _$OperatorUpdateResponse];

  @override
  final String wireName = r'OperatorUpdateResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    OperatorUpdateResponse object, {
  ...
  void _deserializeProperties(
    ...
    required OperatorUpdateResponseBuilder result,
  ...
  @override
  OperatorUpdateResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = OperatorUpdateResponseBuilder();
