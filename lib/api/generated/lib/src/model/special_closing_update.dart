...
part 'special_closing_update.g.dart';

/// SpecialClosingUpdate
///
/// Properties:
/// * [date] 
/// * [reason] 
...
/// * [afternoonToTime] 
@BuiltValue()
abstract class SpecialClosingUpdate implements Built<SpecialClosingUpdate, SpecialClosingUpdateBuilder> {
  ...
  SpecialClosingUpdate._();

  factory SpecialClosingUpdate([void updates(SpecialClosingUpdateBuilder b)]) = _$SpecialClosingUpdate;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SpecialClosingUpdateBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SpecialClosingUpdate> get serializer => _$SpecialClosingUpdateSerializer();
}

class _$SpecialClosingUpdateSerializer implements PrimitiveSerializer<SpecialClosingUpdate> {
  @override
  final Iterable<Type> types = const [SpecialClosingUpdate, _$SpecialClosingUpdate];

  @override
  final String wireName = r'SpecialClosingUpdate';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    SpecialClosingUpdate object, {
  ...
  void _deserializeProperties(
    ...
    required SpecialClosingUpdateBuilder result,
  ...
  @override
  SpecialClosingUpdate deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SpecialClosingUpdateBuilder();
