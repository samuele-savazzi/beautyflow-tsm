...
import 'package:beautyflow_api/src/model/mobile_login_request.dart';
import 'package:beautyflow_api/src/model/mobile_login_response.dart';
import 'package:beautyflow_api/src/model/profile_response.dart';
...
class AuthApi {
  ...
  Future<Response<ChangePasswordResponse>> adminApiAuthChangePasswordCreate({ 
    ...
    final _path = r'/admin-api/auth/change-password/';
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ProfileResponse>> adminApiAuthProfileRetrieve({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/admin-api/auth/profile/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [MobileLoginResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MobileLoginResponse>> authMobileLoginCreate({ 
    required MobileLoginRequest mobileLoginRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/auth/mobile-login/';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(MobileLoginRequest);
      _bodyData = _serializers.serialize(mobileLoginRequest, specifiedType: _type);
    ...
    MobileLoginResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(MobileLoginResponse),
    ...
    return Response<MobileLoginResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
