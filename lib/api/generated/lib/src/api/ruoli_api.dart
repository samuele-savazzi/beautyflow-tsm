...
import 'package:beautyflow_api/src/model/role_list.dart';
...
class RuoliApi {
  ...
  const RuoliApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<RoleList>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<RoleList>>> rolesList({ 
    ...
    BuiltList<RoleList>? _responseData;
    ...
    return Response<BuiltList<RoleList>>(
      data: _responseData,
